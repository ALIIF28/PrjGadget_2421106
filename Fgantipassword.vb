...
Public Class Fgantipassword
    Private Sub cmdgantipassword_Click(sender As Object, e As EventArgs) Handles cmdgantipassword.Click
        ...
        Else
            ...
            perintah.CommandText = "select * from user_2421106 where username='" & useraktif.ToString() & "' and userpass=md5('" & TextBox1.Text & "')"
            ...
            If cek.HasRows Then
                ...
                Else
                    cek.Close()
                    perintah.CommandText = "update user_2421106 set userpass=md5('" & TextBox2.Text & "')
