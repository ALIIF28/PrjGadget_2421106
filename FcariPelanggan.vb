...
Public Class FCariPelanggan
    ...
    Private Sub FCariPelanggan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tampilplg("select pelangganid,pelanggannama from pelanggan order by pelangganid")
        setdg()
    End Sub

    Private Sub txtcari_TextChanged(sender As Object, e As EventArgs) Handles txtcari.TextChanged
        tampilplg("select pelangganid,pelanggannama from pelanggan where pelangganid='" & txtcari.Text & "' or pelanggannama like '%" & txtcari.Text & "%'")
    End Sub
