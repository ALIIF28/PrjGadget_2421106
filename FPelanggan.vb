Public Class FPelanggan
    ...
    Sub tampilpelanggan(ByVal sql As String)
        ...
        ds.Tables.Clear()
        mda.Fill(ds, "pelanggan_2421106")
        dg.DataSource = (ds.Tables("pelanggan_2421106"))
        kon.Close()
    End Sub
    ...
    Private Sub FPelanggan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        tampilpelanggan("SELECT pelangganid, pelanggannama, pelangganalamat, pelanggannohp " &
                       "FROM pelanggan_2421106 ORDER BY pelangganid")
        setdg()
    ...
    Private Sub cmdhapus_Click(sender As Object, e As EventArgs) Handles cmdhapus.Click
        prosespelanggan("DELETE FROM pelanggan_2421106 WHERE pelangganid='" & txtidpelanggan.Text & "'")
    ...
    Private Sub cmdsimpan_Click(sender As Object, e As EventArgs) Handles cmdsimpan.Click
        If cmdsimpan.Text = "Simpan" Then
            prosespelanggan("INSERT INTO pelanggan_2421106 VALUES('" & txtidpelanggan.Text & "', '" &
                           txtnama.Text & "', '" & txtalamat.Text & "', '" &
                           txtidpelanggan.Text & "')")
        Else
            prosespelanggan("UPDATE pelanggan_2421106 SET pelanggannama='" & txtnama.Text & "', " &
                           "pelangganalamat='" & txtalamat.Text & "', " &
                           "pelanggannohp='" & txtidpelanggan.Text & "' " &
    ...
    Private Sub txtcari_TextChanged(sender As Object, e As EventArgs) Handles txtcari.TextChanged
        tampilpelanggan("SELECT pelangganid, pelanggannama, pelangganalamat, pelanggannohp " &
                       "FROM pelanggan_2421106 WHERE pelangganid LIKE '%" & txtcari.Text & "%' " &
    ...
    Private Sub txtidpelanggan_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtidpelanggan.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            perintah.Connection = kon
            perintah.CommandType = CommandType.Text
            perintah.CommandText = "SELECT * FROM pelanggan_2421106 WHERE pelangganid='" & txtidpelanggan.Text & "'"
            ...
            If cek.HasRows Then
                ...
                txtidpelanggan.Text = cek.Item("pelanggannohp")
